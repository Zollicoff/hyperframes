...
- Use at least 2-3 different techniques from techniques.md across the video. Don't default to basic fade/scale/opacity for every beat — mix in SVG path drawing, CSS 3D transforms, typing effects, counter animations, canvas procedural art. Each beat should feel like its own visual world.
