...
| **Dramatic / cinematic** | Zoom through, zoom out, gravity drop, overexposure, diagonal split, color dip to black, cinematic zoom (shader), gravitational lens, domain warp, flash through white, rain on glass | Scale, weight, light extremes. Rain on glass adds atmospheric depth — scene blurs behind fog, drops cut through.          |
| **Premium / luxury**     | Focus pull, blur crossfade, color dip to black, slow crossfade, cross-warp morph, thermal distortion, rain on glass                                                                  | Restraint. Cross-warp morph flows both scenes into each other organically. Rain on glass is slow, atmospheric, immersive. |
...
| Shader (WebGL)       | Domain warp, ridged burn, whip pan, SDF iris, ripple waves, gravitational lens, cinematic zoom, chromatic split, glitch, swirl vortex, thermal distortion, flash through white, cross-warp morph, rain on glass, light leak (shader) |
