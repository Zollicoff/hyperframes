...
| **website-to-hyperframes** | `/website-to-hyperframes` | Capture a website and create a video from it. Full pipeline: capture URL → extract design system → create DESIGN.md → build HyperFrames video. Use when a user provides a URL and wants ANY kind of video. |
